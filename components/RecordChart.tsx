...
const RecordChart = ({ records }: { records: Record[] }) => {
  ...
  if (!records || records.length === 0) {
    return (
      <section className='panel p-5 sm:p-6 min-h-[280px] flex flex-col'>
        {header}
        <div className='flex-1 flex flex-col items-center justify-center text-center py-10 px-4 rounded-2xl border border-dashed border-zinc-300 dark:border-zinc-700 bg-zinc-50/50 dark:bg-black/20'>
          ...
          <h3 className='font-semibold text-zinc-900 dark:text-white mb-1'>No chart data yet</h3>
